...
Nella risoluzione dell?esercizio si implementino le seguenti funzioni:
    int valida (int gioco[N][N], int mossa)
        che riceve la scacchiera e una mossa e restituisce 1 se la mossa ?valida, 0 altrimenti.
    ...
    int risolto (int gioco[N][N])
        che riceve la scacchiera e restituisce 1 se il gioco ?stato risolto, 0 altrimenti.
