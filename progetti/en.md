...
<img src="/progetti/bayesian_html_dashboard2.png" alt="Card Image" style="
border: solid 1px;
margin-bottom: -10px;"> 
</a>
...
~~~
<img src="/progetti/bayesian_shiny_dashboard.png" alt="Card Image" style="
border: solid 1px;
margin-bottom: -10px;"> 
<p style="font-size: 14px; color: grey; line-height: 1.2em; font-style: italic;">
...
{{pdf /progetti/ANNDL_challenge1.pdf }}
{{pdf /progetti/ANNDL_challenge2.pdf }}
...
~~~
<img src="/progetti/classic_15_game.png" alt="Card Image" style="
border: solid 1px;
margin-bottom: -10px;"> 
<p style="font-size: 14px; color: grey; line-height: 1.2em; font-style: italic;">
    classic 15 game
...
<img src="/progetti/generalized_15_game.png" alt="Card Image" style="
border: solid 1px;
margin-bottom: -10px;"> 
</a>
<p style="font-size: 14px; color: grey; line-height: 1.2em; font-style: italic;">
...
async function loadElements() {
	...
	? '/progetti/chem_table_ita.txt' 
	: '/progetti/chem_table_eng.txt';
