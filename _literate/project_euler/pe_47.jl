...
# 1. ogni numero deve avere 4 divisori;
# 2. tutti i divisori devono essere diversi.
# Il controllo sull'essere diversi possiamo farlo con un Set, ovvero un insieme nel senso matematico del termine, che quindi filtra via valori se ne incontra dei duplicati.  
s = []
i = 100
found = 0
@time while found != 1
